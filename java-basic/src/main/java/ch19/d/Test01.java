// static nested class를 응용하여 상수를 관리할때 이점
package ch19.d;
...
public class Test01 {
  public static void main(String[] args) {
    ...
    // => OGNL(Object Graph Navigation Language)의 객체의 하위 프로퍼티 값에 접근하는 표기법.
    // => 문법:
    ...
    // => 다음곽 같이 하나의 이름을 사용하는 대신에 점(.)을 사용하여 하위 프로퍼티를 접근하는 방식은
    //    코드를 읽기 쉽고 유지보수하기 쉽게 만든다.
