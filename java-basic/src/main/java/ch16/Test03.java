...
class Box1 {
  ...
  // => 클래스가 다루는 어떤 타입이 있다고 가정하자. 그타입을 T라고 부르겠다.
  //
}
  class Box2<T> {
    T value;   //T라는 타입의 객체를 저장할 필드
...
public class Test03 {
  public static void main(String[] args) {
    ...
    // 제네릭을 사용하면 getValue() 메서드가 각타입별로 존재하는 것처럼 사용할 수 있다.
    // => 즉 형변환 할 필요가 없다.
    ...
    Date y4 = x4.getValue(); // 형변환 할 필요가 없다.
                                   //  마치 Date 리턴하는 getValue() 메서드가 있는 것 같다.
    
    //제네릭으 다형성의 유연함을 그대로 유지하면서 특정 타입의 데이터를 다루도록
    //도와주는 매우 편리한 문법이다.
