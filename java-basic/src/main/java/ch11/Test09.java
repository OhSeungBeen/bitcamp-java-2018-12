...
public class Test09 {
  public static void main(String[] args) {
    ...
    // 그런데 Wrapper 클래스를 사용하면 primitve도 인스턴스로 다룰 수 있기 때문에
    ...
    printObject(x); // primitve 값을 인스턴스에 담아서 넘길 수 있다.
    printObject(y); // 이것이 Wrapper 클래스 필요한 이유이다.
    printObject(z);
    printObject(today);
