...
public class Test19 {
  ...
  public static void main(String[] args) {
    ...
    // phthon     : 0000 0000 0000 1000 = 0x08
    ...
    //Java 와 C, C++, JavaScript를 할 줄 아는 개발자의 정보를 설정하라!
    int d1 = 0x01 | 0x04 | 0x03 | 0x80; // 0000 0000 1000 0111
    int d2 = 0x0087;
    ...
    System.out.printf("TypeScreipt: %b\n", (d2 & 0x0100) == 0x0100);
