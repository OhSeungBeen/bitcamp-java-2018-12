...
public class Canvas {
  ...
  // 좀 더 추상적인 방식으로 클래스 이름 대신 인터페이스를 사용하여 특정 규칙에 따라 만든 도구를 지정한다.
  // => 이방식의 장점은 규칙에 따라 만든 도구가 어떤 클래스를 상속 받든 상관하지 않는다.
  ...
  // => 오직 Monami의 도구만, Monami의 서브 클래스만 사용할 수 있다.
  ...
  //   매우 편리하다. 어떤클래스를 상속받든 단지 Pen 이라는 규칙만 따르면 되기 때문이다.
  //Monami tool;
