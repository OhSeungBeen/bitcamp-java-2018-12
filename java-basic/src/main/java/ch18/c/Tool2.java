// 다중 인터페이스 구현하지 못하는 경우 - 메서드명과 파라미터는 같은데 리턴 타입이 다른 경우
package ch18.c;
...
public class Tool2 implements ProtocolA, ProtocolC {
  ...
  // 다음메서드는 Protocol A 규칙은 만족시키지만, ProtocolC 규칙은 만족시키지 못한다.
  @Override
  public void m2() {
  ...
  // => 오버로딩 규칙에 따라 파라미터와 메서드명은 같고 리턴값만 다른 메서드를 여러 개 만들 수 없다.
  @Override
  public int m2() {
    System.out.println("Tool.m2()");
    return 0;
