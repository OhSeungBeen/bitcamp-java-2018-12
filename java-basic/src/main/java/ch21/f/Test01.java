...
public class Test01 {
  ...
  public static void main(String[] args) {
    // 자바에서 제공하는 자원들 중에서는 쓰고 난 다음에 헤제시켜야 하는 자원이 있따.
    ...
    // 그래서 자원을 헤제시킬 때 주로 try~ catch ~ finally 에서 처리한다.
    ...
    try {
      ...
      try {
        ...
        //자원을 해제시키다가 예외가 발생한 경우 개발자가 처리할 게 없다.
        // 그래서 예외를 받기만 하는 특별히 뭔가를 수행하지는 않는다.
      }
