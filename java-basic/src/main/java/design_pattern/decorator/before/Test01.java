...
public class Test01 {
  public static void main(String[] args) {
    ...
    //    무조건 상속 받을 수 밖에 없다.
    HybirdTruck c1 = new HybirdTruck();
    c1.dump();
    
    // 만약 Hybrid 이면서 convertiable 기능을 갖는 자동차를 만들고 싶다면?
    // => Hybird나 convertiable 둘 중 한개를 상속 받아서 구현해야 한다.
    // => 하위 클래스는 다른 클래스의 기능을 중복해서 개발해야 한다.
    
    HybridConvertiable c2 = new HybridConvertiable();
    c2.open(true);
    c2.run2();
    
    
    // Convertible 자동체에 간단히 물건을 내리는 덤프 기능을 포함한다면?
