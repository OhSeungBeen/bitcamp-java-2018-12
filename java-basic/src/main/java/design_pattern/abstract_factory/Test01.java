...
public class Test01 {
  ...
  public static void main(String[] args) {
    // 설계
    //UnitFactory 인터페이스 : 공장 객체에 사용 규칙을 정의
    // AbstractUnitFactory 추상 클래스 : UnitFactory의 사용 규칙을 구현, 일부 메서드는 탬플릿으로
    ...
    // ZergUnitFactory 클래스: AbstractUnitFactory 서브 클래스, 저그족에 맞춰서 유닛 생성
