// 콘솔로 출력하기 III - 형식으로 갖춰 날짜 값 출력하기
package ch02;
...
public class Test13 {
  public static void main(String[] args){
    ...
    // m : 날짜 및 시각 데이터에서 월을 추출하여 2자리 숫자로 표현한다. ex) 01
    System.out.printf("%1$tm\n ",today);
    
    // d : 날짜 및 시각 데이터에서 일을 추출하여 2자리 숫자로 표현한다. ex) 01
    // e : 날짜 및 시각 데이터에서 일을 추출하여 1자리 숫자로 표현한다  ex) 1
