...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    d1 = 98765.43; //주의! 8바이트 부동소수점을 표현 할때는 F , f 접미사를 제거하라.
    d2 = 98765.43456789;
    System.out.println(d1);
    System.out.println(d2); // 유효자릿수 15자리 까지 대부분 짤리지 않고 들어간다.
    ...
    bool1 = true;
    bool2 = false;
    //bool3 = 1; //컴파일 오류! ture false 외의 다른 값은 저장할 수 없다.
    ...
    c1 = 44032; // 4바이트 정수 리터럴이더라도 2바이트 0 ~ 65535까지의 값이라면
