...
public class Test11 {
  ...
  public static void main(String[] args){
   ...
   // #C언어
   // =>C에서는 배열을 만들때 개수를 바로 지정한다.
   //int arr2[5]; 자바는 이런 문법을 지원하지 않는다. 컴파일 오류!
    
    // #자바
    // 1)배열을 가리킬 레퍼런스 선언
    // 레퍼런스(reference)? 메모리에 주소를 저장하는 변수
    ...
    //arr1[5]; //ArrayIndexOutOfBoundsException 예외 발생
