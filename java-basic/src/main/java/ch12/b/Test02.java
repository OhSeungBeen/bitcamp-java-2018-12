...
public class Test02 {
  ...
  public static void main(String[] args) {
    ...
    System.out.printf("총점=%d, 평균=%.1f",s1.getSum(),s1.getAver());
 ...
 *  - 클래스 멤버(스태틱멤버): 스태틱 필드, 스태틱 블록, 스태틱 메서드
 ...
 *  - 
 * 4) 다형성(polymorphism)
 *  - 한나의 코드가 여러 용도로 쓰이게 하는 것.
 *  - 오버로딩(overloading) 
 *     - 메서드 시그너처가 다르더라도 같은 기능을 하는 메서드에 대해 같은 이름을 갖게하여 코딩할 때 일관성을 주는 것
 ...
 * getter/setter
 * - 캡슐화와 더불어 사용되는 기술이다.
 * - 필드에 대해 외부의 직접적인 접근을 막는 대신 메서드를 통해 값을 변경, 조회 하도록 유도한다.
