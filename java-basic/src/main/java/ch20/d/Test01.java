...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    // 맵에 값 저장하기
    // => Key 객체에 대해 hashCode()를 호출하여 정수 값을 얻ㄴ느다.
    ...
    // 3) 해당 위치에 있는 key 객체와 equals()를 호출하여 린턴값을 확인한다.
    ...
    System.out.println(key1.equals(key2)); // equals 리턴 값이 true이다.
    // 결론 :key 1과 key2는 서로 다른 인스턴스이지만, hashCode()의 리턴 값이 같고,
    //        equals()의 리턴 값이 true이므로 두인스턴스는 같은 key로 간주한다.
