...
(function() {
  ...
  xhr.onreadystatechange = function() {
    ...
    // body 태그에 헤더 로딩을 완료 했다는 이벤트를 보낸다.
...
// header.html이 사입되지도 않았는데 로그아웃 버튼을 찾아서는 안된다.
...
// header.html이 웹페이지에 삽입된 후 로그인 정보를 받아온다.
function loadLoginUser() {
  ...
  xhr.onreadystatechange = function() {
    ...
    if (data.status == 'success'){
      ...
      document.querySelector('#login-username').src = 
